                ...
                <div class="col-lg-5">
                    <div class="breadcrumbs-area sec-heading">
                        <div class="sub-inner mb-15">
                            <a class="breadcrumbs-link" href="index.html">Home</a><span class="sub-title"> Collections</span>
                            <img class="heading-left-image" src="images/mtj6NOzc0cBE.png" alt="Steps-Image">
                        </div>
                        <h2><a class="title" href="#">Collections</a></h2>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="join_comunity_btns list-btn">
                        <button class="wishlist_btn hov_shape_show" href={{ route("collection")}}>
                        ...
                        <button disabled class="join_discord_btn hov_shape_show">
